...
public class App {
    ...
    public static void main(String[] args) {
        ...
        double ongkirPlatinum = member8.hitungOngkir(20.5);
        double ongkirGold = member7.hitungOngkir(15.3);
        double ongkirSilver = member6.hitungOngkir(10.0);
        ...
        System.out.println("STRUK MEMBER");
        System.out.println("");
